...
#define REQUIRE_TRUE(condition)                                                                                      \
    {                                                                                                                \
        if (!(condition)) {                                                                                          \
            std::cerr << std::string(__FILE__) + std::string(":") + std::to_string(__LINE__) + std::string(" in ") + \
...
#define REQUIRE_EQUAL(x, y)                                                                                          \
    {                                                                                                                \
        if ((x) != (y)) {                                                                                            \
            std::cerr << std::string(__FILE__) + std::string(":") + std::to_string(__LINE__) + std::string(" in ") + \
                             std::string(__PRETTY_FUNCTION__) + std::string(": ") + std::to_string((x)) +            \
...
#define REQUIRE_NEAR(x, y, tol)                                                                                      \
    {                                                                                                                \
        if (std::abs((x) - (y)) >= (tol)) {                                                                          \
            std::cerr << std::string(__FILE__) + std::string(":") + std::to_string(__LINE__) + std::string(" in ") + \
                             std::string(__PRETTY_FUNCTION__) + std::string(": |") + std::to_string((x)) +           \
                             std::string(" - ") + std::to_string((y)) + std::string("|  < ") + std::to_string((tol)) \
                      << std::endl;                                                                                  \
            std::exit(1);                                                                                            \
        }                                                                                                            \
    }
